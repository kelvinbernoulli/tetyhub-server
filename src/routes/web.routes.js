...
const paymentLimit = rateLimit({
    ...
    message: {
        success: false,
        message: 'Too many payment requests; retry shortly',
    },
});
...
router.get(
    '/subcategories',
    pagination,
    SubcategoriesController.fetchSubcategories
);
...
router.get(
    '/childcategories',
    pagination,
    ChildcategoriesController.fetchChildcategories
);
